...
<template>
    <div class="my-8 px-4">
        <div class="relative flex justify-center items-center">
            ...
            <h1
                class="text-2xl text-center drop-shadow-lg font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#0390EA] to-blue-800 w-[35dvh] mt-2">
                Application Status
            </h1>
        </div>
        <table class="w-full relative">
            <thead>
                <tr class="text-blue-500 text-[18px] text-left">
                    ...
                    <th class="h-[10dvh] px-3">Interview Date</th>
                    <th class="h-[10dvh] px-3">Interview Time</th>
                    <th class="h-[10dvh] px-3">Application Status</th>
                </tr>
            </thead>
            <tbody>
                <tr v-for="app_status in application_status"
                    ...
                    <td class="text-blue-700 font-bold cursor-pointer">
                        <h1 v-if="app_status.application_status === 'Received'" class="text-xs"> ASSIGN <br> INTERVIEW
                        </h1>
